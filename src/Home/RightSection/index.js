...
export function RightSection({ title = "", shade }) {
  return (
    <Wrapper shade={shade}>
      ...
      <Container>
        ...
        <div className="pl5-ns">
          ...
          <div className="f4 black-70 measure lh-copy">
            <p>
              Redundant verification, validation & maintenance of duplicate
              documents are all mandated in current land registry system because
